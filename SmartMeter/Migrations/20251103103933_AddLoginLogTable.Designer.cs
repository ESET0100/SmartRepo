...
namespace SmartMeter.Migrations
{
    ...
    [Migration("20251103103933_AddLoginLogTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartMeter.Models.LoginLog", b =>
                {
                    ...
                    b.HasIndex("AttemptResult")
                        .HasDatabaseName("IDX_LoginLog_AttemptResult");

                    b.HasIndex("AttemptTime")
                        .HasDatabaseName("IDX_LoginLog_AttemptTime");

                    b.HasIndex("ConsumerId")
                        .HasDatabaseName("IDX_LoginLog_ConsumerId");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IDX_LoginLog_UserId");

                    b.HasIndex("UserType")
                        .HasDatabaseName("IDX_LoginLog_UserType");

                    b.HasIndex("AttemptTime", "UserType")
                        .HasDatabaseName("IDX_LoginLog_Time_UserType");

                    b.HasIndex("UserType", "Identifier")
                        .HasDatabaseName("IDX_LoginLog_UserType_Identifier");

                    b.ToTable("LoginLog", t =>
                        {
                            t.HasCheckConstraint("CHK_LoginLog_AttemptResult", "\"AttemptResult\" IN ('Success','InvalidPassword','UserNotFound','Inactive','Deleted')");

                            t.HasCheckConstraint("CHK_LoginLog_UserType", "\"UserType\" IN ('User','Consumer')");
                        });
                });
